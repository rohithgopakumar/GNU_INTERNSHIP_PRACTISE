...
class Complex_Baseband(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Complex_Baseband")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_float_to_complex_0_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_float_to_complex_0, 1))
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_float_to_complex_0_1, 0))
        ...
        self.connect((self.blocks_float_to_complex_0_1, 0), (self.qtgui_freq_sink_x_0, 2))
...
def main(top_block_cls=Complex_Baseband, options=None):
