...
class vector_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "vector_block")
        ...
        self._A2_range = qtgui.Range(-2, 2, 0.1, -0.5, 200)
        ...
        self._A1_range = qtgui.Range(-2, 2, 0.1, 1, 200)
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f(A2*numpy.sinc(t_vals-1), True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_f(A1*numpy.sinc(t_vals), True, 1, [])
    ...
    def set_t_vals(self, t_vals):
        self.t_vals = t_vals
        self.blocks_vector_source_x_0.set_data(self.A1*numpy.sinc(self.t_vals), [])
        self.blocks_vector_source_x_0_0.set_data(self.A2*numpy.sinc(self.t_vals-1), [])
...
def main(top_block_cls=vector_block, options=None):
