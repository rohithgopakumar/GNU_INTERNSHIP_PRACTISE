...
class Windowing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Windowing")
        ...
        self._freq_range = qtgui.Range(100, 16000, 0.1, 1000, 200)
...
def main(top_block_cls=Windowing, options=None):
