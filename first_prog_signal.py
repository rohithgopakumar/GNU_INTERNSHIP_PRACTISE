...
class first_prog_signal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "first_prog_signal")
        ...
        self._freq_range = qtgui.Range(1000, 15000, 1, 1000, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 4500, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=first_prog_signal, options=None):
