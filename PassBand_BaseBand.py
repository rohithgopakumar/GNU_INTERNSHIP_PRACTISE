...
class PassBand_BaseBand(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PassBand_BaseBand")
        ...
        # Variables
        ##################################################
        self.t_taps = t_taps = numpy.arange(-512,512) /32
        ...
        self._fc_range = qtgui.Range(3000, 8000, 1, 3000, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f(numpy.sinc(t_taps)**2, True, 1, [])
        self.blocks_vector_source_x_0 = blocks.vector_source_f(numpy.sinc(t_taps), True, 1, [])
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, fc, (-1.414), 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0_2, 1))
        ...
        self.connect((self.blocks_vector_source_x_0_0, 0), (self.blocks_multiply_xx_0_0, 0))
    ...
    def set_t_taps(self, t_taps):
        self.t_taps = t_taps
        self.blocks_vector_source_x_0.set_data(numpy.sinc(self.t_taps), [])
        self.blocks_vector_source_x_0_0.set_data(numpy.sinc(self.t_taps)**2, [])
...
def main(top_block_cls=PassBand_BaseBand, options=None):
